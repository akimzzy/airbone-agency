  ...
  return (
    <AnimatedSection className="relative h-[100vh] flex items-center justify-end overflow-hidden flex-col px-4 sm:px-0 py-36">
      <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center max-w-7xl">
        <h1 className="font-damion text-4xl sm:text-5xl md:text-6xl font-normal mb-4 sm:mb-2 leading-tight tracking-tight text-[var(--color-primary)] flex flex-wrap justify-center gap-x-2 flex-col">
          <div className="">
        ...
        <motion.p
          ...
          className="text-sm sm:text-base mb-8 max-w-2xl mx-auto leading-relaxed text-[var(--color-secondary)] font-semibold px-2 sm:px-0"
        >

  ...
  return (
    <Transition show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-y-0 right-0 z-10 overflow-hidden text-[var(--color-primary)]">
          <div className="flex min-h-screen">
            ...
            >
              <DialogPanel className="relative w-full max-w-xl transform overflow-hidden bg-gradient-to-br from-white/95 via-white/85 to-white/75 shadow-xl transition-all sm:rounded-l-3xl flex flex-col h-screen">
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex-1 overflow-y-auto bg-white pb-[calc(5rem+env(safe-area-inset-bottom))]">
                    ...
                    {/* CTA Section */}
                    <section className="fixed bottom-0 left-0 right-0 bg-white py-6 px-6 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] pb-30 w-screen sm:w-auto sm:pb-[calc(1.5rem+env(safe-area-inset-bottom))]">
